...

{
    ...
    clsString String2("Fahad");
    String1.SetValue("Ahmed Badawi");
    ...
    cout << "Number of words: " << String1.CountWords("Fadi mohmmad omer") << endl;

    cout << "Number of words: " << clsString::CountWords("Fahad badawi ateleh") << endl;
    ...
    cout << "Capital Letters count : "
         << clsString::CountLetters("Fahad badawi", clsString::CapitalLetters)
         << endl
         << endl;
    ...
    String3.SetValue("Fahad badawi mohammad");
    cout << "\n\nString     = " << String3.GetValue();
    ...
    String3.SetValue("Fahad badawi Alqasi");
    cout << "\nReplace : " << String3.ReplaceWord("Fahad", "Alyam")
         << endl;
